            ...
            <div class="editor-main display-flex display-flex-column">
                <div class="action-bar display-flex display-flex-row">
                    <div class="action-left display-flex-auto">
                        ...
                        <button class="action-item editor-icon" data-action="bold">
                        ...
                        <button class="action-item editor-icon" data-action="italic">
                        ...
                        <button class="action-item editor-icon" data-action="list">
                            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-list-ul" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                <path fill-rule="evenodd" d="M5 11.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm0-4a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5zm-3 1a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm0 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
                            </svg>
                        </button>
                        <button class="action-item editor-icon" data-action="quote">
                        ...
                        <button class="action-item editor-icon" data-action="code-slash">
                    ...
                    <div class="action-right">
                        <div class="action-item" title="About markdown">
