        ...
        return `
            <div class="images-lib-container display-flex-column">
                <div class="images-lib-action-bar display-flex-row">
                    <div class="images-lib-current-container">Current: <span class="images-lib-current">Github</span></div>
        ...
        return `
            <div class="images-lib-item">
                ...
                <div class="images-lib-item-parent">
                    <span class="images-lib-item-delete hide" data-sha="{{ data.sha }}" data-name="{{ data.name }}" data-lib="{{ data.lib }}">
