    ...
    this.layout = function() {
        return `
            <div class="folder-main display-flex display-flex-column">
                ...
                <div class="notebooks-container display-flex-auto">
        ...
        return `
            <div class="folder-item-edit-container">
                <div class="folder-item-edit display-flex-row">
                    <div class="display-flex-auto">
                        <input type="text" class="folder-item-edit-input" data-id="{{ data['id'] }}" data-parent-id="{{ data.parentId }}" data-name="{{ data.name }}" value="{{ data.name }}" />
                    </div>
